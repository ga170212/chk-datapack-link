...
scoreboard players enable @a is_showing_chat
...
# 채팅 표시 여부 변경 트리거
execute as @a[scores={is_showing_chat=1..}] run function chat_block_rain:trigger/apply_is_showing_chat

scoreboard players set @a cooltime 0
scoreboard players set @a blocks_per_chat 0
scoreboard players set @a is_showing_chat 0
